...
<div class="customer-header">
    <div class="setout bit-ti-s po-re">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td><a href="/"><img src="<?php echo ($tpshop_config['shop_info_store_logo']); ?>" alt="logo"></a></td>
                <td class="pa-le-5"><img src="/Template/pc/default/Static/images/split1.png" /></td>
...
<div class="setout">
    <div class="login-area">
        ...
        <form action="<?php echo U('Home/User/do_login');?>" method="post">
                    ...
                    <table class="pa-10-0" width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td class="po-re">
                                ...
                                <img class="po-ab to0" id="verify_code_img" width="120" height="40" src="<?php echo U('Home/User/verify');?>"  onclick="verify(this)" />
                                <a><img class="ma-le-142 po-ab to18" src="/Template/pc/default/Static/images/chg_image.png" id="verify_code_img2"  onclick="verify(this)" /></a>
                            </td>
                        </tr>
                        <tr>
                            <td class="pa-to-30">
                                <input class="ma-ri-5 fo-fa-ta" type="checkbox" id="remember_name"/><label for="remember_name">记住用户名</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a class="fo-fa-ta co929292" href="<?php echo U('User/forget_pwd');?>" >忘记密码？</a>
                            </td>
                        </tr>
                        <tr>
        ...
        <span><a class="hezuoz" href="<?php echo U('LoginApi/login',array('oauth'=>'alipay'));?>"><i class="zhi-y-f"></i></a></span>
        <span><a class="hezuoz" href="<?php echo U('LoginApi/login',array('oauth'=>'qq'));?>"><i class="ba-po--185"></i></a></span>
        <p class="nu-miaf">没有账号？&nbsp;&nbsp;<a href="<?php echo U('Home/User/reg');?>">免费注册</a></p>
