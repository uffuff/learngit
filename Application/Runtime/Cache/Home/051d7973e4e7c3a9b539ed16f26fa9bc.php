...
<div class="sc-pro-list">
  <table width="100%" border="0" cellspacing="0" cellpadding="1">
      <tr class="ba-co-danhui">
       ...
       <th align="center" valign="middle">消费积分</th>
     ...
     <?php if(is_array($cartList)): foreach($cartList as $k=>$v): ?><tr>
        ...
        <td align="center" valign="middle">
         ...
         <td style="border-left:0px" align="center" valign="middle"><span><?php echo ($v["goods_jifen"]); ?></span></td>
...
<div class="sc-total-list ma-to-20 sc-pro-list">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <?php
 if(!empty($total_price['xiaofei_jifen'])) { ?>
       <tr>
        <td>&nbsp;</td>
        <td id="bo-to-dedede" width="190" align="right">可用消费积分：</td>
        <td id="bo-to-dedede" width="97" align="right"><?php echo ($total_price["xiaofei_jifen"]); ?>分=<?php echo ($jifen_money); ?>元</td>
        <td>&nbsp;</td>
      </tr>
      <?php  } ?>
      ...
      <tr>
        ...
        <td id="bo-to-dedede" width="69" align="right"><em>￥<?=$total_price['total_fee']-$jifen_money?></em></td>
        <td>&nbsp;</td>
      </tr>
    </table>
</div>