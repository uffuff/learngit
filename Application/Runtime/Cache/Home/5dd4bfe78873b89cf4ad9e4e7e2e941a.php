...
<?php if(isset($message)) {?>
   <!-- 处理成功 -->
   <div class="box-ts">
    	<i><img src="/Template/pc/default/Static/images/success_ts.png"></i>         
        <ul>
