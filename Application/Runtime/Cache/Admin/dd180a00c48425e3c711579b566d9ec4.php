                        ...
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
                                ...
                                <tr>
                                   ...
                                   <tr>
                                	<td>预约吃饭奖励积分：</td>
                                	<td><input type="number" pattern="^\d{1,}$" title="只能输入数字" class="input-sm" name="appointment" value="<?php echo ($config["appointment"]); ?>"></td>
                                	<td>当用户预约吃饭的时候就要增加个人用户的积分</td>
                                </tr>  
                                    <tr>
                                	<td>取消预约吃饭奖励积分：</td>
                                	<td><input type="number" pattern="^\d{1,}$" title="只能输入数字" class="input-sm" name="cancel_reservation" value="<?php echo ($config["cancel_reservation"]); ?>"></td>
                                	<td>当用户取消预约吃饭的时候就要增加个人用户的积分</td>
                                </tr>  
                              	<tr>
                                    <td>附件上传大小：</td>
                                    <td>                         		
                            	...
                            	<tr>
                                    <td>开启APP测试：</td>
                                    <td >
                                       	 关<input type="radio" class="" name="app_test" value="0" <?php if($config[app_test] == 0): ?>checked="checked"<?php endif; ?>>
                                       	 开<input type="radio" class="" name="app_test" value="1" <?php if($config[app_test] == 1): ?>checked="checked"<?php endif; ?>>                               
                                    </td>
                                	<td></td>
                                </tr>                                
                                </tbody> 
