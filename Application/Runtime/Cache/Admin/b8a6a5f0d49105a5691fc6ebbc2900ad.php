                                ...
                                <tr>
                                    ...
                                    <td >                         		
                                        <select class="form-control" name="auto_confirm_date" id="distribut_date">
                                                <?php $__FOR_START_22352__=1;$__FOR_END_22352__=31;for($i=$__FOR_START_22352__;$i < $__FOR_END_22352__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($config[auto_confirm_date] == $i): ?>selected="selected"<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                                        </select>                                      
                                    </td>
                                </tr> 
                                <tr>
                                    <td>减库存的时机：</td>
                                    <td >                         		
                                        <input type="radio" class="" name="reduce" value="1" <?php if($config[reduce] == 1): ?>checked<?php endif; ?>>订单支付时  &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" class="" name="reduce" value="2" <?php if($config[reduce] == 2): ?>checked<?php endif; ?>>发货时  &nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                </tr>                              
                                </tbody> 
                                <tfoot>
