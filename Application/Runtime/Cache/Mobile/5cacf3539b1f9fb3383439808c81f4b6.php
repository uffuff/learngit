...
<section class="filtrate_term" id="product_sort" style="width: 100%;background:#FFF;">
		<ul>
        <li class="<?php if(($_GET[sort] == '') or ($_GET[sort] == 'is_new')): ?>on<?php endif; ?>"><a href="<?php echo urldecode(U('Mobile/Goods/search',array_merge($filter_param,array('sort'=>'is_new')),''));?>">最新</a></li>
		...
		<li class="<?php if($_GET[sort] == 'comment_count'): ?>on<?php endif; ?>"><a href="<?php echo urldecode(U('Mobile/Goods/search',array_merge($filter_param,array('sort'=>'comment_count')),''));?>">评论</a></li>
		<li class="<?php if($_GET[sort] == 'shop_price'): ?>on<?php endif; ?>"><a href="<?php echo urldecode(U('Mobile/Goods/search',array_merge($filter_param,array('sort'=>'shop_price','sort_asc'=>$sort_asc)),''));?>">价格<span class="arrow_up"></span><span class="arrow_down"></span></a></li>
		<li class=""><a href="javascript:;" class="show_type  show_list">&nbsp;</a></li>
		</ul>
</section>
<section>
<div class="touchweb-com_searchListBox openList" id="goods_list">
  <?php if(empty($goods_list)): ?><p class="goods_title">抱歉暂时没有相关结果，换个筛选条件试试吧</p>
  <?php else: ?> 
...
var  page = 1;
 ...
 {	 	 	 
		...
		$.ajax({
			type : "GET",
			url:"<?php echo urldecode(U('Mobile/Goods/search',array_merge($filter_param,array('sort'=>$_GET[sort],'sort_asc'=>$_GET[sort_asc])),''));?>/is_ajax/1/p/"+page,//+tab,
...
<section class="_next" style="-webkit-transform-origin: 0px 0px 0px; opacity: 1; -webkit-transform: scale(1, 1); display: none;">
	...
	<section id="filter_content">
	     ...
	     <form method="post" action="<?php echo U('Goods/search');?>"> 
	     <?php if(!empty($filter_brand)): ?><div class="filtrate_category" >
      ...
      <!--价格帅选-->
      <?php if($filter_price != null): ?><div class="filtrate_category" >
		        ...
		        <ul class="clearfix filtrate_address filtrate_list att_item">
			       <?php if(is_array($filter_price)): foreach($filter_price as $k=>$v): ?><li>
     ...
     <!--价格帅选 end-->                                            	      
	    ...
	    <ul class="filtrate_btn">
	        <li><a href="<?php echo U('Goods/search');?>" class="reset" id="clear_btn">取消筛选</a></li>
...
<script type="text/javascript" src="/Template/mobile/new/Static/js/zepto.min.js"></script>
<script type="text/javascript" src="/Template/mobile/new/Static/js/filter.min.js"></script>
<script>
...
<footer><div style="height:50px; line-height:50px; clear:both;"></div>
<div class="v_nav">
	<div class="vf_nav">
		<ul>
...
<!-- 微信浏览器 调用微信 分享js  end--></footer>
<script>
function goTop(){
	$('html,body').animate({'scrollTop':0},600);
}
</script>
<a href="javascript:goTop();" class="gotop" style=" z-index:9999"><img src="/Template/mobile/new/Static/images/topup.png"></a> 
</body>
</html>