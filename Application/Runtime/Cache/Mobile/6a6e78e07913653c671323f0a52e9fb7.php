<?php if (!defined('THINK_PATH')) exit();?><style type="text/css">
 ...
 <?php if(is_array($cartList)): foreach($cartList as $k=>$v): ?><div  class="block" style="margin-top:0px;">
      <div class="shop_title" >
        <div class="fl"><a class="shopLink eclipse" href="javascript:void(0);">供货商：<?php echo ($tpshop_config['shop_info_store_name']); ?></a>
...
<section class="f_block" id="choose" style="height:0px;"></section> 
 ...
 <?php else: ?>
	 ...
	 <div class="bottom-panel">
	   ...
	   <div class="info">
	     <span class="hot" id="cart_amount_desc"><em>总计:</em>￥<?php echo ($total_price["total_fee"]); ?>元 <?php if($total_price['xiaofei_jifen']>0){ ?>-积分<?php echo ($total_price["xiaofei_jifen"]); ?>=<?=$total_price['total_fee']-$total_price['xiaofei_jifen']?> <?php } ?></span>
	     <br>
